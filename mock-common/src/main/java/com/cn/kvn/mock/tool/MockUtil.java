...
//			e.printStackTrace();
    ...
    public List<Foo2> methodList() {
        return null;
    }
    
    public Map<Integer, Foo2> methodMap() {
        return null;
    }
...
//		System.out.println(randomInstanceOfNonCollection(int.class));
//		System.out.println(randomInstanceOfNonCollection(Integer.class));
//		System.out.println(randomInstanceOfNonCollection(Date.class));
//
//		Foo foo = randomInstanceOfNonCollection(Foo.class);
//		System.out.println(JSON.toJSONString(foo));
//
//		Method methodList = MockUtil.class.getMethod("methodList");
//		Object obj = randomMethodReturnTypeInstance(methodList);
//		System.out.println(JSON.toJSONString(obj));
		
		Method methodMap = MockUtil.class.getMethod("methodMap");
		Object obj2 = randomMethodReturnTypeInstance(methodMap);
...
class Foo {
    ...
    public List<Foo2> getList() {
        return list;
    }

    public void setList(List<Foo2> list) {
        this.list = list;
    }

     public Map<String, Foo2> getMap() {
     return map;
     }
    
     public void setMap(Map<String, Foo2> map) {
     this.map = map;
     }

    public Set<Foo2> getSet() {
        return set;
    }

    public void setSet(Set<Foo2> set) {
        this.set = set;
    }
}
